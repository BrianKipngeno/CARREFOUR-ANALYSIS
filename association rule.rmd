...
## b) Metric of Success
> The goal of this project is to Identify the relationships between the Groups of Items provided
...
transaction <- read.transactions("http://bit.ly/SupermarketDatasetII",sep=",")
head(transaction)
```
